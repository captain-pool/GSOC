...
class RRDBNet(tf.keras.models.Model):
  ...
  def call(self, input_):
    ...
    feature = self.lrelu(self.upsample1(tf.nn.depth_to_space(feature, block_size=2)))
    feature = self.lrelu(self.upsample2(tf.nn.depth_to_space(feature, block_size=2)))
